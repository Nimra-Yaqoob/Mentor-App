...
import 'organizationhome.dart';
import 'organizationsignup.dart';

class OrgnizationLoginScreen extends StatefulWidget {
  const OrgnizationLoginScreen({super.key});

  @override
  State<OrgnizationLoginScreen> createState() =>
      _OrganizationLoginScreenState();
}

class _OrganizationLoginScreenState extends State<OrgnizationLoginScreen> {
          ...
          child: Column(
            ...
            children: [
              ...
              Wrap(
                children: [
                  Text(
                    "By signing up to MentorSpark you agree to our ",
                    style: TextStyle(
                      fontSize: 14,
                      fontWeight: FontWeight.w600,
                      color: Colors.black,
