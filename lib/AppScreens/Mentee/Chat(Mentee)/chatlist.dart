...
import 'package:mentorapp/AppScreens/Mentee/Chat(Mentee)/chathome.dart';
  ...
  Stream<List<Map<String, dynamic>>> _fetchChats() {
    return FirebaseFirestore.instance
      ...
      for (var doc in snapshot.docs) {
        ...
        // Check if mentee's name and image URL are available in chatData
        final senderName = chatData['senderName'] ?? 'Unknown';
        final senderImageUrl =
            chatData['senderImageUrl'] ?? 'https://via.placeholder.com/150';
